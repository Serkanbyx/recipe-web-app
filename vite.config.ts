    ...
    VitePWA({
      ...
      workbox: {
        ...
        runtimeCaching: [
          ...
          {
            // Cache Spoonacular images
            urlPattern: /^https:\/\/spoonacular\.com\/recipeImages\/.*/i,
            handler: 'CacheFirst',
            options: {
          ...
          {
            // Cache Unsplash images (for category thumbnails)
          ...
          {
            // Cache Netlify Functions API responses
            urlPattern: /^\/api\/.*/i,
